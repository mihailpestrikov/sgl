...
if (wavePath && typeof anime !== 'undefined' && !window.waveAnimationInstance) {
    ...
    window.waveAnimationInstance = anime({
        targets: '#wavePath',
        easing: 'linear',
        duration: 8000,
        loop: true,
    ...
    window.addEventListener('beforeunload', function() {
        if (window.waveAnimationInstance) {
            window.waveAnimationInstance.pause();
        }
    });
}
